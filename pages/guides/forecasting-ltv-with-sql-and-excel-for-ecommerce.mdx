...
In this guide, we assume that you’re using the tracking scheme we described in [How to implement an e-commerce tracking plan](https://segment.com/docs/guides/how-to-guides/forecast-with-sql/#calculating-ltv-buy-til-you-die) and are storing data in a [Segment Warehouse.](https://segment.com/warehouses)
...
![](https://segment.com/docs/guides/how-to-guides/images/forecast_MiUlaNKr.jpg)
...
![](https://segment.com/docs/guides/how-to-guides/images/forecast_JBqlb4Hf.png)
...
![](https://segment.com/docs/guides/how-to-guides/images/forecast_GkZFJP5q.png)
...
![](https://segment.com/docs/guides/how-to-guides/images/forecast_3N82oB4v.png)
...
[Talk to a product specialist](https://segment.com/contact/sales/) to _learn how companies like Warby Parker and Crate & Barrel use a data warehouse to increase engagement and sales._
