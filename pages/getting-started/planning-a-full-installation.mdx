...
- [Define Business Objectives](https://segment.com/docs/getting-started/03-planning-full-install/#define-business-objectives)
- [Decide what to collect](https://segment.com/docs/getting-started/03-planning-full-install/#decide-what-to-collect)
  - [Shortcut: Check if a Business Spec meets your needs](https://segment.com/docs/getting-started/03-planning-full-install/#shortcut-check-if-a-business-spec-meets-your-needs)
    - [B2B Spec](https://segment.com/docs/getting-started/03-planning-full-install/#b2b-spec)
    - [Ecommerce Spec](https://segment.com/docs/getting-started/03-planning-full-install/#ecommerce-spec)
    - [Mobile Spec](https://segment.com/docs/getting-started/03-planning-full-install/#mobile-spec)
    - [Video Spec](https://segment.com/docs/getting-started/03-planning-full-install/#video-spec)
- [Create naming conventions](https://segment.com/docs/getting-started/03-planning-full-install/#create-naming-conventions)
- [Develop a Tracking Plan](https://segment.com/docs/getting-started/03-planning-full-install/#develop-a-tracking-plan)
  - [Plan your Identify and Group calls](https://segment.com/docs/getting-started/03-planning-full-install/#plan-your-identify-and-group-calls)
  - [Plan your Track events](https://segment.com/docs/getting-started/03-planning-full-install/#plan-your-track-events)
  - [Define your Track event properties](https://segment.com/docs/getting-started/03-planning-full-install/#define-your-track-event-properties)
- [Plan for destination tools](https://segment.com/docs/getting-started/03-planning-full-install/#plan-for-destination-tools)
...
If your organization sells a product or services to other businesses, you might have different analytics and marketing needs than most companies. You need to understand your customer behaviors both at the user-level, and also at the company or team-level. You can read more about [how Segment thinks about B2B tracking](https://segment.com/academy/collecting-data/tracking-plans-for-b2b-companies/), and [read more about the B2B Spec.](https://segment.com/docs/connections/spec/b2b-saas/)

### Ecommerce Spec

If your organization sells products online, the E-commerce Spec covers the customer’s journey as they browse your store, click on promotions, view products, add those products to a cart, and complete a purchase. It also provides recommendations about off-page interactions, including interactions with email promotions, coupons, and other systems. You can read more about [why companies need an Ecommerce Spec](https://segment.com/blog/2014-08-28-ecommerce-analytics-story/), read more about [Ecommerce tracking plans](https://segment.com/docs/connections/spec/ecommerce-tracking-plan/), and dive directly into our [Ecommerce Spec.](https://segment.com/docs/connections/spec/ecommerce/v2/)

### Mobile Spec

The native Mobile Spec is a common blueprint for the mobile user lifecycle. The Spec outlines the most important events for mobile apps to track, and automatically collects many of these events when you use the [Segment Android and iOS SDKs](https://segment.com/docs/connections/sources/catalog/#mobile). Read more about the [benefits of the native mobile spec](https://segment.com/docs/connections/spec/native-mobile-spec/), or read through [the Native Mobile Spec](https://segment.com/docs/connections/spec/mobile) directly.

### Video Spec

Segment’s video spec helps you understand how customers engage with your video and ad content, including playback events, types of media displayed, and performance metrics. You can [read more about our Video Spec.](https://segment.com/docs/connections/spec/video/)
...
![](https://segment.com/docs/protocols/images/asset_nVdJ3ZyA.png)
...
Once you’ve completed your tracking plan, there’s one more step you might want to do before you move on to actually implementing Segment. [The Segment destination catalog](https://segment.com/docs/connections/destinations/catalog/) contains hundreds of tools, many of which you’ll be familiar with already.
...
Additionally, you should check [which connection modes each tool supports](https://segment.com/docs/connections/destinations/cmodes-compare/), so you know ahead of time which destinations may need to be bundled.
