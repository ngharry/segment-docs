...
![](https://segment.com/docs/images/segment-diagram.png)
...
> Destination filters for mobile device-mode destinations are in beta and only supports [Swift](https://segment.com/docs/connections/sources/catalog/libraries/mobile/swift-ios#destination-filters), [Kotlin (Android)](https://segment.com/docs/connections/sources/catalog/libraries/mobile/kotlin-android/#destination-filters), and [React Native 2.0](https://segment.com/docs/connections/sources/catalog/libraries/mobile/react-native/#destination-filters) libraries.

> Keep [these limitations](https://segment.com/docs/connections/destinations/destination-filters/#limitations) in mind when using destination filters.

![](https://segment.com/docs/guides/images/destination-filter-create.png)
...
3. Go to the **Filters** tab and click **+ New Filter** to create a destination filter. See the [Destination Filters documentation](https://segment.com/docs/connections/destinations/destination-filters/) for more details.
...
![](https://segment.com/docs/guides/images/schema-integration-filters.png)
...
![](https://segment.com/docs/guides/images/schema-event-filters.png)
